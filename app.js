...
(() => {
  ...
  const PACKAGES = [
    ...
    {
      title:'Nepal Himalayan Gateway',
      category:'International Himalayan Tour',
      duration:'5 Days / 4 Nights',
      price:'Custom Rate',
      per:'tailored quote',
      highlights:['Kathmandu Durbar Square & Swayambhunath Stupa tour','Pokhara Phewa Lake boating & David\'s Fall waterfall','Sarangkot mountain sunrise view over Annapurna range','Nagarkot hill station panoramic Himalayan sunset','On-arrival visa assistance for Bangladesh passport holders'],
      itinerary:[{day:'Day 1',desc:'Kathmandu arrival, Thamel walk, welcome dinner.'},{day:'Day 2',desc:'Kathmandu sightseeing, scenic drive to Pokhara.'},{day:'Day 3',desc:'Sarangkot sunrise, Phewa Lake boating & Gupteshwor Cave.'},{day:'Day 4',desc:'Nagarkot hill resort & sunset over Mt. Everest.'},{day:'Day 5',desc:'Departure transfer to Tribhuvan International Airport.'}],
    },
    {
      title:'Maldives Luxury Beach Resort',
      category:'International Island Retreat',
      duration:'4 Days / 3 Nights',
      price:'Custom Rate',
      per:'tailored quote',
      highlights:['Luxury island resort overwater villa / beachfront villa','Speedboat return airport transfers included','Coral reef snorkeling, kayak & paddleboard access','Romantic beachside candlelight dinner','On-arrival 30-day free tourist visa for Bangladeshis'],
      itinerary:[{day:'Day 1',desc:'Male Airport arrival, luxury speedboat transfer, resort check-in.'},{day:'Day 2',desc:'Coral reef snorkeling excursion & sunset dolphin cruise.'},{day:'Day 3',desc:'Water sports, spa treatment & romantic candlelight beach dinner.'},{day:'Day 4',desc:'Resort breakfast, speedboat transfer, return flight.'}],
    },
    {
      title:'Sri Lanka Tropical Explorer',
      category:'International Cultural Tour',
      duration:'5 Days / 4 Nights',
      price:'Custom Rate',
      per:'tailored quote',
      highlights:['Sigiriya UNESCO Lion Rock Fortress climb','Kandy Temple of the Sacred Tooth Relic & cultural show','Nuwara Eliya "Little England" rolling tea plantations','Bentota beach resort stay & Madu River boat safari','Full Sri Lanka ETA Tourist Visa assistance included'],
      itinerary:[{day:'Day 1',desc:'Colombo arrival, transfer to Pinnawala Elephant Orphanage & Kandy.'},{day:'Day 2',desc:'Sigiriya Rock Fortress trek, spice garden tour.'},{day:'Day 3',desc:'Nuwara Eliya tea garden & Gregory Lake.'},{day:'Day 4',desc:'Bentota beach resort relaxation & Madu River safari.'},{day:'Day 5',desc:'Colombo city tour, departure transfer.'}],
    },
    {
      ...
      price:'Custom Rate',
      per:'tailored quote',
      highlights:['Paro Taktsang (Tiger\'s Nest) cliffside monastery trek','Thimphu 169ft giant Buddha Dordenma statue','Punakha Dzong fortress at the confluence of two rivers','Dochula Pass 108 memorial chortens with Himalayan views','Full Bhutan tourist entry visa & SDF fees included'],
      itinerary:[{day:'Day 1',desc:'Paro international flight arrival, transfer to Thimphu capital.'},{day:'Day 2',desc:'Thimphu sights (Buddha Point, Tashichho Dzong) → Punakha.'},{day:'Day 3',desc:'Punakha Dzong & suspension bridge → return to Paro.'},{day:'Day 4',desc:'Iconic Tiger\'s Nest Monastery cliff hike.'},{day:'Day 5',desc:'Paro airport transfer, departure.'}],
    },
    {
      title:'Singapore Futuristic City Break',
      category:'South East Asia Package',
      duration:'4 Days / 3 Nights',
      price:'Custom Rate',
      per:'tailored quote',
      highlights:['4-Star Hotel near Orchard Road / Marina Bay','Gardens by the Bay Supertree Grove & Flower Dome ticket','Sentosa Island Cable Car & Universal Studios Singapore','Marina Bay Sands Skypark observation deck','Express Singapore Tourist Visa processing included'],
      itinerary:[{day:'Day 1',desc:'Changi Airport arrival, Jewel Changi waterfall, hotel check-in.'},{day:'Day 2',desc:'Universal Studios Singapore full day adventure on Sentosa.'},{day:'Day 3',desc:'City tour (Merlion Park, Chinatown) + Gardens by the Bay night show.'},{day:'Day 4',desc:'Orchard Road shopping, airport transfer.'}],
    },
    {
      ...
      price:'Custom Rate',
      per:'tailored quote',
      highlights:['4-Star Hotel in Kuala Lumpur City Centre','Petronas Twin Towers & KL Tower photo tour','Genting Highlands mountain cable car & indoor theme park','Batu Caves 140ft golden Murugan statue & rainbow steps','Express Malaysia Tourist E-Visa processing included'],
      itinerary:[{day:'Day 1',desc:'Kuala Lumpur arrival, Bukit Bintang night market & street food.'},{day:'Day 2',desc:'City tour — Petronas Twin Towers, King\'s Palace, Independence Square.'},{day:'Day 3',desc:'Batu Caves + Genting Highlands day trip via Awana SkyWay cable car.'},{day:'Day 4',desc:'Souvenir shopping at Central Market, airport transfer.'}],
    },
  ];
